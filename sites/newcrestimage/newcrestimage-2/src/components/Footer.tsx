        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-6 text-sand/70 max-w-sm leading-relaxed">
              A Dallas-based family office investment firm building long-term
              value across hospitality, real estate, and alternative assets.
            </p>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-sand/80">
              ...
              <li><Link to="/approach" className="hover:text-gold">Investment Approach</Link></li>
              ...
              <li><Link to="/about/leadership" className="hover:text-gold">Leadership</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <address className="not-italic text-sand/80 leading-relaxed">
              ...
              <a href="tel:2147744650" className="hover:text-gold">214-774-4650</a><br />
